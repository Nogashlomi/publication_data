...
# Paths
BOOK_DATA_PATH = '/Users/nogashlomi/projects/Image_data/dissertation/full_book_data_feb_25.csv'
IMAGE_DATA_PATH = '/Users/nogashlomi/projects/Image_data/dissertation/full_image_data_feb_25.csv'
UCK_DATA_PATH = '/Users/nogashlomi/projects/Image_data/dissertation/all_elements_all_ck_ucks.xlsx'
OUTPUT_DIR = '/Users/nogashlomi/projects/Image_data/university_comparison'
OUTPUT_JSON = os.path.join(OUTPUT_DIR, 'books_data.json')
...
def process_data():
    ...
    OUTPUT_UNIV = os.path.join(OUTPUT_DIR, 'universities_data.json')
